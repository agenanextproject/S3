...
const locationStorageCheck = require('./apiUtils/object/locationStorageCheck');
...
function objectCopy(authInfo, request, sourceBucket,
    ...
    return async.waterfall([
        ...
        function checkStorageQuota(storeMetadataParams, dataLocator,
            sourceBucketMD, destBucketMD, destObjMD,
            sourceLocationConstraintName, backendInfoDest, next) {
            ...
            return locationStorageCheck(storeMetadataParams.size, null, null,
                storeMetadataParams.dataStoreName, log, err => {
                    if (err) {
                        return next(err, destBucketMD);
                    }
                    return next(null, storeMetadataParams, dataLocator,
        ...
        function goGetData(storeMetadataParams, dataLocator, sourceBucketMD,
            ...
            backendInfoDest, isVersionedObj, next) {
