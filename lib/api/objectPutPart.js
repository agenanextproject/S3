...
function objectPutPart(authInfo, request, streamingV4Params, log,
    ...
    return async.waterfall([
        ...
        // Check that part does not exceed location storage quota
        (destinationBucket, objectLocationConstraint, cipherBundle,
        splitter, next) => locationStorageCheck(size, null, null,
            objectLocationConstraint, log, err => next(err, destinationBucket,
