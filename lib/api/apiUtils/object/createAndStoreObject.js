...
const locationStorageCheck = require('./locationStorageCheck');
    ...
    services.metadataStoreObject(bucketName, dataGetInfo,
        cipherBundle, metadataStoreParams, (err, result) => {
            ...
            const returnObj = Object.assign(
                { dataStoreName: dataGetInfo[0].dataStoreName }, result);
...
function createAndStoreObject(bucketName, bucketMD, objectKey, objMD, authInfo,
    ...
    if (versioningNotImplBackends[locationType] && isVersionedObj) {
